...
const SearchBar = () => {
    ...
    return (
        <form onSubmit={submitForm} className="flex box-border px-2 items-center justify-center">
            <div className="rounded-lg border border-solid border-primary-blue">
                <div className="flex">
                    ...
                    <input type="submit" value="Search" className="cursor-pointer px-2 h-8 rounded-tr-lg rounded-br-lg text-white font-semibold bg-secondary-blue transition-colors" />
                </div>
            </div>
        </form>
